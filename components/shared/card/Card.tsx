...
const Card: React.FC<CardProps> = ({
  ...
  const renderTextContent = () => {
    ...
    return (
      <div className="px-4 space-y-0.5 md:space-y-2 ">
        ...
        {title && (
          <h3
            className={`font-cormorant  leading-tight text-black ${titleClassName}`}
          >
            {title}
          </h3>
        )}
          ...
          >
            ...
            >
              {/* <div className="block lg:hidden relative h-full">
                ...
                <Decoration
                  opacity="full"
                  responsive="visible-only-on-mobile"
                  preset={shapePosition}
                  className="bg-primary m-2 rounded-lg"
                >
                  {cornerContent}
                </Decoration>
              </div> */}
